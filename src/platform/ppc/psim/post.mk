...
run:
	cd $(BASEDIR)/src/platform/$(ARCH)/$(PLATFORM) && xterm -e "stty raw -echo onlcr -icanon -iexten onocr opost ofdel; $(PREFIX)run -r 128m -m $(CPU) -e  netbsd -f psim.init $(BINARY_NAME); sleep 10"
